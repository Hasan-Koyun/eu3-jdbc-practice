...
public class Pojo_deserialize {
    ...
    public void oneSpartanPojo(){
        Response response = given().accept(ContentType.JSON)
                .pathParam("id", 15)
                .when().get("http://34.228.77.208:8000/api/spartans/{id}");
    ...
    public void regionToPojo(){
        ...
        Response response = when().get("http://34.228.77.208:1000/ords/hr/regions");
    ...
    public void gson_example(){
        ...
        Map<String, Object> map = gson.fromJson(myJsonData, Map.class); //burada alttakinin normalde mape dönüsmesi hali
